...
export default class Board extends React.PureComponent {
  ...
  async componentDidUpdate(prevProps) {
    const { previousMove, onTransitionOut, puzzle, teardown } =
      this.props;
    const didMovePiece =
      puzzle !== prevProps.puzzle && previousMove !== null;
    const shouldTeardown = teardown && !prevProps.teardown;
  ...
  renderSquare = (square, index) => {
    ...
    console.log('renderSquare', square, index);
